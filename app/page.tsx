  ...
  return (
    <main className="relative z-10 min-h-screen flex flex-col">
      ...
      <section className="z-10 flex-1 flex flex-col justify-center px-8 max-w-3xl mx-auto w-full">
        <p className="rise text-accent text-sm uppercase tracking-[0.3em] mb-6">
          Base de projet
        </p>
        ...
        <p className="rise text-muted text-lg max-w-xl mb-12 leading-relaxed">
          Connexion via Discord, sessions en base, gestion de profil. Tout est
          câblé — il ne reste qu'à brancher tes clés et pousser sur Vercel.
        </p>
          ...
          <div className="rise flex items-center gap-4">
            <div className="flex items-center gap-3">
              ...
              <span className="text-sm">
                ...
                <span className="text-paper">{session.user.name}</span>
              </span>
            </div>
            <form
              action={async () => {
      ...
      <footer className="z-10 px-8 py-6 text-xs text-muted">
        Next.js 15 · Auth.js · Drizzle · Turso
      </footer>
    </main>
  );
}
